...
class ConfigModel(BaseModel):
    ...
    ADAFACE_MODEL_FILE: str = Field(default="models/adaface_ir18_webface4m.ckpt", alias="adaface_model_file")
    FAISS_DATABASE_PATH: str = Field(default=FAISS_DATABASE_PATH.as_posix(), alias="faiss_database_path")
    INDEX_DATABASE_PATH: str = Field(default=INDEX_DATABASE_PATH.as_posix(), alias="index_database_path")
